...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='ingredient',
            options={'ordering': ('name',), 'verbose_name': 'Ингрединет', 'verbose_name_plural': 'Ингрединенты'},
        ),
        migrations.AlterModelOptions(
            name='recipe',
            options={'ordering': ('-create_at',), 'verbose_name': 'Рецепт', 'verbose_name_plural': 'Рецепты'},
        ),
        migrations.AlterModelOptions(
            name='tag',
